                ...
                <aside className="hidden sm:flex sm:flex-col">
                    ...
                    <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
                        <nav className="flex flex-col mx-4 my-6 space-y-4">
                            ...
                            <Link to="/admin/create-new-book" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
                    ...
                    <main className="p-6 sm:p-10 space-y-6 ">
                        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                            ...
                            <div className="flex flex-col md:flex-row items-start justify-end -mb-3">
                                ...
                                <Link to="/admin/create-new-book" className="inline-flex px-5 py-3 text-white bg-purple-600 hover:bg-purple-700 focus:bg-purple-700 rounded-md ml-6 mb-3">
                        ...
                        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                            ...
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span className="inline-block text-xl text-gray-500 font-semibold">{`(${data?.trendingBooks}%)`}</span>
